...
class Preprocess(object):
    ...
    def postprocess(
        ...
        polarity_value = data[0] if isinstance(data, list) else data
        message = f"Predicted sentiment is {polarity_map.get(polarity_value, 'unknown')}."

        return {"polarity": polarity_value, "message": message}
